...
namespace K2WorkflowMap
{
    ...
    public class WorkflowInstanceFramework : Iworkflowframeworkcs
    {
        ...
        public  int StartProcess(string Folio, string ProcessName)
        {
            ...
            string ProjectName = ProcessName.Split('\\')[0];
            string proc = ProcessName.Split('\\')[1];

            string workflowname =(ProjectName  + @"\" + proc);
            ...
            try
            {
                SourceCode.Workflow.Client.ProcessInstance K2Proc = K2Conn.CreateProcessInstance(@workflowname.Trim());
        ...
        /// <param name="ProcessName"></param>
        /// <returns></returns>
        public  Boolean IsTaskFound(string ProcessInstanceId, string ProcessName)
        {
            int ProcInstId = 0;
        ...
        /// <param name="ProcessInstanceId"></param>
        /// <returns></returns>
        public  int GetTaskCount(string ProcessInstanceId,string ProcessName)
        {
        ...
        /// <returns></returns>
        public  Boolean IsTaskComplete(string ProcInst, int Count,string processname)
        {
            Boolean result = false;
            int LastCount = Count;
        ...
        /// <param name="processinstanceId"></param>
        /// <returns></returns>
        public  string GetWorkflowStatus(string processinstanceId)
        {
            ...
            try
            {
                SourceCode.Workflow.Client.ProcessInstance K2Proc = K2Conn.OpenProcessInstance(ProcInstId);
        ...
        /// <param name="processinstanceId"></param>
        /// <returns></returns>
        public  List<dataField> GetProcessDataFields(string processinstanceId)
        {
            int ProcInstId = 0;
            int.TryParse(processinstanceId, out ProcInstId);
        ...
        public Boolean CompareActivities(string ProcessInstanceId, string Activities)
        {
            int ProcInstId = 0;
            int.TryParse(ProcessInstanceId, out ProcInstId);
