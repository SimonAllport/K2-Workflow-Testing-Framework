...
namespace K2WorkflowUnitTest
{
    ...
    public class UnitTest1
    {
        ...
        public void StartWorkflow_Running_Success()
        {
            ...
            string actual = workflow.GetWorkflowStatus(this.proceessInstance.ToString());
        ...
        public void WorkList_TasksFound_Success()
        {
            ...
            actual = workflow.IsTaskFound(this.proceessInstance.ToString(), this.ProcessName);
        ...
        public void WorkList_CorrectNumberOfTasksCreated_Success()
        {
            int.TryParse(Results.GetResult(TestType.ProcessInstance), out this.proceessInstance);
            int actual = 0;
            actual = workflow.GetTaskCount(this.proceessInstance.ToString(), this.ProcessName);
        ...
        public void WorkList_RetrieveTaskList_Success()
        {
            ...
            var task = workflow.GetTask(this.proceessInstance.ToString(), this.ProcessName);
        ...
        public void Activities_CorrectActivitiesRan_Success()
        {
            ...
            Boolean actual = workflow.CompareActivities(this.proceessInstance.ToString(), this.Activities);
